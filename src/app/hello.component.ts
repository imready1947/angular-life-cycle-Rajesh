...
export class HelloComponent implements OnChanges, OnInit, DoCheck, AfterContentInit, AfterContentChecked, AfterViewInit, AfterViewChecked, OnDestroy  {
  ...
  private GetMockData():Array<any>{
    return [
    {Name:'sample data p unhale',IsApplyEllipses:false},
    {Name:'sample data pankaj unhale',IsApplyEllipses:false},
    {Name:'sample data pankaj unhale',IsApplyEllipses:false},
    {Name:'sample data pankaj madhukarao unhale',IsApplyEllipses:false},
    {Name:'sample data pankaj m u',IsApplyEllipses:false},
    {Name:'sample data shraman unhale 3 d NHSS',IsApplyEllipses:false}
    ];
  }
